...
on n(t, e) {
  var n,
    ...
    i = []
  for (
    a.addRule(t, 'foo:bar'), n = 0;
    n < o && !('bar' === r[n].currentStyle.foo && (i.push(r[n]), i.length > e));
    n += 1
  );
...
;(u = document),
    ...
    Object.defineProperty(u, e, {
      get: function () {
        try {
          ...
          for (
            o === a &&
            ((r = u.documentElement.outerHTML),
            (i = new RegExp(
              '(?:[^\\n]+?\\n){0,' + (i - 2) + '}[^<]*<script>([\\d\\D]*?)<\\/script>[\\d\\D]*',
              'i'
            )),
  ...
  Array.prototype.indexOf ||
    (Array.prototype.indexOf = function (t, e) {
      ...
      e |= 0
      if (o <= e) return -1
      for (n = Math.max(0 <= e ? e : o - Math.abs(e), 0); n < o; n++)
          ...
          (t = setTimeout(function () {
            ...
            if (0 <= n) {
              ...
              do {
                if (
                  (e = s[r - n]) &&
                  (((t = p(e.mql.media)) && !e.mql.matches) || (!t && e.mql.matches)) &&
                  ((e.mql.matches = t), e.listeners)
                )
                  for (var o = 0, i = e.listeners.length; o < i; o++)
                    e.listeners[o] && e.listeners[o].call(c, e.mql)
              } while (n--)
            }
          }, 10))
      }
      var h = c.document,
        ...
        p = function (t) {
          ...
          do {
            if (
              ((d = !1),
              (e = (l = s[c - u]).match(S)) && ((h = e[0]), (p = e.index)),
              !e || (-1 === l.substring(0, p).indexOf('(') && (p || (!e[3] && h !== e.input))))
            )
              T = !1
            else {
              if (
                  ...
                  i &&
                    (v =
                      'px' === i
                        ...
                        : Number(o)),
                  (T =
                    'min-' === r && v ? v <= a : 'max-' === r && v ? a <= v : v ? a === v : !!a)) &&
                  g--
                )
              if (T) break
            }
        ...
        (function () {
          ...
          for (
            n.type = 'text/css',
              n.id = 'mediamatchjs',
              e.appendChild(n),
              t = (c.getComputedStyle && c.getComputedStyle(n)) || n.currentStyle;
            o < i;
            o++
          )
            a += '@media ' + r[o] + ' { #mediamatchjs { position: relative; z-index: ' + o + ' } }'
          n.styleSheet ? (n.styleSheet.cssText = a) : (n.textContent = a),
            (w = r[+t.zIndex || 0]),
            e.removeChild(n),
            d(),
            u(s + 'resize', l, !1),
            u(s + 'orientationchange', l, !1)
        })(),
        function (t) {
          var o = u,
            e = {
              ...
              removeListener: function (t) {
                var e,
                  ...
                  r = 0
                if (n)
                  for (e = n.listeners.length; r < e; r++)
                    n.listeners[r] === t && n.listeners.splice(r, 1)
              },
            }
          return (
            '' === t
              ? (e.matches = !0)
              : ((e.matches = p(t)), (u = s.push({ mql: e, listeners: null }))),
            e
          )
        }
      )
          ...
          var i,
            ...
            n =
              ...
              (d.prototype._writeImpl = function (t) {
                ...
                for (
                  var e = void 0, n = void 0, r = void 0, o = [];
                  (e = this.parser.readToken()) && !(n = c.isScript(e)) && !(r = c.isStyle(e));
              ...
              (d.prototype._buildChunk = function (t) {
                for (
                  var e = this.actuals.length, n = [], r = [], o = [], i = t.length, a = 0;
                  a < i;
                  a++
                ) {
                  var s,
              ...
              (d.prototype._walkChunk = function () {
                for (var t, e = [this.proxyRoot]; c.existy((t = e.shift())); ) {
                  var n = 1 === t.nodeType
                  ;(n && r(t, 'proxyof')) ||
                    (n && o((this.actuals[r(t, 'id')] = t), 'id'),
                    (n = t.parentNode && r(t.parentNode, 'proxyof')) &&
                      this.actuals[n].appendChild(t)),
              ...
              (d.prototype._shouldRelease = function (t) {
                return (
                  ...
                  !!(this.options.releaseAsync && t.src && t.hasAttribute('async'))
                )
              }),
              d)
          function d(t) {
            ...
            function (t, e, n) {
              ...
              function d() {
                ...
                var r,
                  ...
                  i = {}
                for (r in a)
                  a.hasOwnProperty(r) && (n.autoFix && (i[r + 'Fix'] = !0), (o = o || i[r + 'Fix']))
                o
                  ...
                  (e.TagToken =
                    ((s.formatTag = function (t) {
                      var e,
                        ...
                        o = '<' + t.tagName
                      for (e in t.attrs)
                        t.attrs.hasOwnProperty(e) &&
                          ((o += ' ' + e),
                          (n = t.attrs[e]),
                          (void 0 !== t.booleanAttrs && void 0 !== t.booleanAttrs[e]) ||
                            (o += '="' + (0, i.escapeQuotes)(n) + '"'))
                      return (
                        t.rest && (o += ' ' + t.rest),
                        (o += t.unary && !t.html5Unary ? '/>' : '>'),
                        null != r && (o += r + '</' + t.tagName + '>'),
                        o
                      )
                    }),
                    s)))
            ...
            function (t, e) {
              ...
              function u(t) {
                return (
                  t &&
                    'startTag' === t.type &&
                    ((t.unary = n.test(t.tagName) || t.unary),
                ...
                (e.default = function (r, n, o) {
                  ...
                  var t,
                    ...
                    s = {
                      ...
                      endTag: function (t) {
                        a.last()
                          ? n.tagSoupFix && !a.lastTagNameEq(t.tagName)
                            ? c(r, a)
                            : a.pop()
                          : n.tagSoupFix && (o(), i())
                      },
  ...
  (LazyHTML = (function () {
    'use strict'
    console.log(
      'Powered by LazyHTML: https://github.com/Niresh12495/LazyHTML ```Lazy Load Ads, Images, Widgets, CSS, JS and any HTML```'
    )
    var t = !1
      ...
      var r,
        o = (r =
          !0 === e
            ? '0%'
            : null == n
            ? ((r = '100%'), /Mobile/i.test(navigator.userAgent) || !1 ? '175%' : '125%')
            : n + '%')
      ;(r = '0% 0% ' + r + ' 0%'),
          ...
          function (t, r) {
            t.forEach(function (t) {
              if (((i = new Date().getTime()), t.isIntersecting)) {
                var e = t.target
                ;(y = e.getAttribute('data-matchmedia') || !1),
                  (f = parseInt(e.getAttribute('data-adwidth'), 0) || !1),
                  (m = parseInt(e.getAttribute('data-adheight'), 0) || !1),
                  (l = S(e))
                for (var n = 0; n < l.length; n++) {
                  if (
                    ((h = l[n]),
                    (v = 'true' === e.getAttribute('data-lazyhtml-loaded')),
                    (f || m) &&
                      ((p = e.offsetWidth),
                      (d = e.offsetHeight),
                      (g = f && p < f ? !1 : !0),
    ...
    function w(t) {
      ;(i = new Date().getTime()),
        (y = t.getAttribute('data-matchmedia') || !1),
        (f = parseInt(t.getAttribute('data-adwidth'), 0) || !1),
        (m = parseInt(t.getAttribute('data-adheight'), 0) || !1),
        (l = S(t))
      for (var e = 0; e < l.length; e++) {
        if (
          ((h = l[e]),
          (v = 'true' === t.getAttribute('data-lazyhtml-loaded')),
          (f || m) &&
            ((p = t.offsetWidth),
            (d = t.offsetHeight),
            (g = f && p < f ? !1 : !0),
    ...
    function b(t, e, n) {
      ...
      if ('querySelectorAll' in document) (r = t), (a = n.querySelectorAll((r += e ? '.' + e : '')))
        ...
        for (q = n.getElementsByTagName(t), i = 0; i < q.length; i++)
          (o = q[i]),
            !1 === e
              ? a.push(o)
              : s
              ? o.classList.contains(e) && a.push(o)
              : o.className && -1 !== o.className.split(/\s/).indexOf(e) && a.push(o)
      return a
    }
    function S(t) {
      for (var e, n, r = b('script', !1, t), o = [], i = 0; i < r.length; i++)
        (n = (e = r[i]).getAttribute('type')) && 'text/lazyhtml' === n && o.push(e)
      return o
    }
    function x(t, e, n) {
    ...
    function k() {
      var t = (function () {
        for (var t, e = b(o.containerElement, o.containerClass), n = [], r = 0; r < e.length; r++)
          !0 == (null !== (t = e[r]).getAttribute('data-lazyhtml')) && n.push(t)
        return n
      })()
      t &&
        0 < t.length &&
          ...
          for (
            ...
            (c = t[r]),
              !n || null !== c.getAttribute('eager')
                ...
                ? ((e = c.getAttribute('threshold')),
                  isNaN(e) ? T(c, !1) : T(c, !1, c.getAttribute('threshold')))
                : T(c, !1)
        })(t)
    }
