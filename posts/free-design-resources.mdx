...
### A growing curated list of design tools
...
[Desygner](https://desygner.com/): Desygner is a [graphic design tool](https://desygner.com/) for small business owners, marketers, and non-designers who need to create marketing content such as social media posts, ads, presentations, business cards, flyers, and more. One of the best parts of Desygner is that you can access more than a hundred million Shutterstock images royalty-free.
...
The prototyping tools are a low-cost development tool that allows the developer or the designer to quickly develop screens, reports, and forms to give end-users the “look and feel” of the information system.
...
One of the important steps towards a unified product is creating and owning a design system on which to base the product design, realization, and development. A design system is essential to the teams from the beginning of a project until it is shipped.
...
Miscellaneous tools are design tools that are not easily classified as others in this list. Therefore, I put them under this section.

[Isoflow](https://isoflow.io/): A network diagramming tool that produce isometric dagrams of your network.
...
<svg
    ...
    className="blur-blob blur-three-colors-post-design -z-10"
>
...
[Pattern Generator](https://doodad.dev/pattern-generator/): A pattern generator with some customization options.

[Glitch Image Generator](https://glitchyimage.com/): Upload your image and customize the glitch effect on it.

[Sombras](https://sombras.app/): Do art shadows with cubes and letters.

[Readme Generator](https://readme.so/): Write your readme files with an intuitive GUI.
...
[SVG Blobs: Blobbb](https://www.blobbb.fun/): An **SVG blob generator** tool that creates relatively customizable blobs.
...
[Material Design Icon Generator](https://fonts.google.com/icons?selected=Material+Icons):

[Shotsnap Mockups](https://app.shotsnapp.com/):

[Headline & Title Generator](https://figen.cc/?ref=cbsofyalioglu):

[TryShape](https://tryshape.vercel.app/app): TryShape allows you to get pre-made SVG shapes.
...
[Get Waves](https://getwaves.io/): Get Waves is a web app that produces wave patterns in SVG format. Basically, it is an *svg wave generator*.

[SVG Waves](https://svgwave.in/?ref=cbsofyalioglu): Another **svg wave generator** that produces wave patterns in SVG or PNG formats.
...
[Fancy Border Generator](https://9elements.github.io/fancy-border-radius/): This online design resource allows you to make *fancy border vectors*.
...
[Non-boring Gradients](https://non-boring-gradients.netlify.app/): Create beautiful gradients.

[CSS Buttons Generator](https://markodenic.com/tools/buttons-generator/): A dozens of buttons with copy/paste styles.

[CSS Shapes](https://css-tricks.com/the-shapes-of-css/): This is a **CSS shape generator** that provides pre-made shapes that are completely written by CSS code.

[CSS Clamp Generator](https://maximeroudier.com/): CSS clamp function clamps a middle value within a range of values between a defined minimum and maximum. You can visually experiment it with this tool.

[Clippy CSS Clip Path Generator](https://bennettfeely.com/clippy/):Bennett Freely's *CSS clip path maker* tool.

[Animated Background Generator](https://animated-gradient-background-generator.netlify.app/): Animate background gradients with CSS.

[3D Book Image CSS Generator](https://3dbookcovergenerator.netlify.app/): A 3D book cover generator that produces CSS code.

[Underline Generator](https://underline-generator.netlify.app/): A CSS underline generator with different gradient colors and font weights.

[Curated CSS Shadows](https://getcssscan.com/css-box-shadow-examples): A curated list of CSS shadows.
...
[Glass UI](https://ui.glass/generator/): A free **glassmorphism generator** based on the glassmorphism design specifications to quickly design and customize the style properties.
...
[CSS & SVG Filter](https://justcode.today/): A CSS filter tool.
...
[Clip Path Generator](https://www.mixfont.com/shadows): Easily create a clip-path with this **clip path generator** from Uplabs.
...
[SVG Repo](https://www.svgrepo.com/): It is a free SVG repository that includes more than 300.000 vector graphics. Just bookmark it, you'll need it later.

[Snoweb](https://www.snoweb-svg.com/en/): You can get SVG icons in HTML and CSS.
