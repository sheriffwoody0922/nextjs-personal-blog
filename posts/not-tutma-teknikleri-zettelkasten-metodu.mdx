...
Aşağıdaki görselde, diğer notlarımdan **Zettelkasten Metodu** isimli bu yazıyı yazmadan önce oluşturduğum notuma, diğer notlardan gelen bağlantıları görebilirsiniz.

![Obsidian Backlink](/posts/obsidian-backlink.webp)
