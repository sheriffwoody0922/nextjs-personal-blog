...
#### 6) [Renote](https://renote.so)

<ImageZoom
    src="/posts/not-alma/renote.webp"
    width={1400}
    height={580}
    alt="Speare not uygulaması"
/>

Renote çalışma alanınız üzerinde işbirliğine dayalı görseller üretip, notlar ekleyebilmenizi sağlayan ücretsiz bir **dijital not alma uygulaması**.
