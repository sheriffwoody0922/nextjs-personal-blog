...
I will continue this tutorial on NestJS with this second post. Previously, I've shared my notes on some of the concepts of NestJS. I made an introduction first; then, I introduced modules, controllers, and pipes to you. In this part, I'm going to cover providers and services along with the concept of "Dependency Injection".
