...
tags:
  - "not-alma"
  - "obisidan"
  - "markdown uygulamalar"
  - "personal knowledgebase"
keywords:
  - "obisidian md"
  - "obsidian uygulaması"
  - "obisidian not alma uygulaması"
related:
...
Daha önce [Zettelkasten metodunu ](/not-alma/not-tutma-teknikleri-zettelkasten-metodu/) uygulayabileceğiniz not alma uygulamalarına örnekler verirken Obsidian not alma uygulaması da kısaca adından bahsettirmişti. Ayrıca [Not Alma Uygulaması Seçenekleri](https://www.cbsofyalioglu.com/not-alma/not-alma-uygulamasi-ve-teknikleri/) isimli yazıda da çevrimdışı çalışabilen uygulamalar listesinde yer almıştı.
...
- ![Obsidian Nord teması](/posts/obsidian-nord-theme-light.jpg)
...
![Obsidian Publish](/posts/obsidian-publish.gif)
...
Eğer Obsidian Publish kullanarak bir mini-blog açmayı düşünüyorsanız ancak ücreti biraz yüksek bulduysanız [blog yazma siteleri](https://www.cbsofyalioglu.com/blog-acmak/en-iyi-blog-siteleri/) başlıklı yazıma da göz atabilirsiniz.

![Obsidian uygulaması](/posts/banner.png)
...
<CardEnlarge
    ...
    cover="/posts/obsidian-roundup.webp"
...
![Obsidian Todoist eklentisi](/posts/obsidian-todoist-sync.gif)
