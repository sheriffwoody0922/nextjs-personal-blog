...
1. GET http://localhost:3000/words (Bring all words)
2. POST http://localhost:3000/words (Create a new word)
3. GET http://localhost:3000/words/:id (Bring a word with the given name)
