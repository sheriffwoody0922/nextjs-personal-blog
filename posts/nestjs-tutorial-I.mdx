...
1. GET http://localhost:3000/words (Bring all messages)
2. POST http://localhost:3000/words (Create a new message)
3. GET http://localhost:3000/words/:id (Bring a message with the given id)
