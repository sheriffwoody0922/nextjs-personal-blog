export const site = {
  ...
  description:
    'An engineer interested in web stuff; backend, frontend, search, automation, no-code, etc.',
  locale: 'en-US',
  type: 'website',
  ...
  author: {
    ...
    logo: {
      '@id':
        'https://cbsofyalioglu.fra1.cdn.digitaloceanspaces.com/cbs/webmeister/webmeister-gradient-logo.webp',
    },
    image: {
      '@type': 'ImageObject',
      ...
      'inLanguage': 'tr',
      'url':
        'https://cdn.statically.io/img/www.cbsofyalioglu.com/f=auto%2Cq=75/wp-content/uploads/2021/03/T5BKxHAu-cbsofyalioglu-black.png',
      'contentUrl':
        'https://cdn.statically.io/img/www.cbsofyalioglu.com/f=auto%2Cq=75/wp-content/uploads/2021/03/T5BKxHAu-cbsofyalioglu-black.png',
      'width': 203,
      'height': 43,
